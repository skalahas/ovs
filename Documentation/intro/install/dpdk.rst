...
#. Download the `DPDK sources`_, extract the file and set ``DPDK_DIR``::
       ...
       $ cd /usr/src/
       $ wget http://git.dpdk.org/dpdk-stable/snapshot/dpdk-stable-20.11.2-rc2.tar.xz
       $ tar xf dpdk-stable-20.11.2-rc2.tar.xz
       $ export DPDK_DIR=/usr/src/dpdk-stable-20.11.2-rc2
       $ cd $DPDK_DIR
